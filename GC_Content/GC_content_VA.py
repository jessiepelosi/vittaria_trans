...
** This should be used with the Vittaria+Adiantum only ortholog set where there are three sequences in each orthogroup **
'''
...
GC_app_t = float(GC_total[1]) #V. appalachiana is always the second sequence in these ortholog pairs 
GC_lin_t = float(GC_total[2])
GC_app_3 = float(GC_third[1])
GC_lin_3 = float(GC_third[2])
